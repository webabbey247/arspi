...
{/* ============ ABOUT SECTION ============ */}
<section className="px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 py-12 sm:py-16 md:py-20 lg:py-24 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-24 items-start bg-white">
  <div>
   ...
   <div className="flex flex-col gap-3 sm:gap-4">
    ...
    <div className="flex flex-col gap-3 sm:gap-4">
          ...
          <div className="mt-6 sm:mt-8 flex flex-col gap-px bg-slate-200 border border-slate-200 ">
            {[
              ...
              <div
                key={item}
                className="bg-white py-3.5 sm:py-4 md:py-[1.2rem] px-4 sm:px-5 md:px-6 flex items-center gap-3 sm:gap-3.5 transition-colors duration-200"
              >
                <span className="w-2 h-2 rounded-full bg-[#0474C4] shrink-0" />
                <span className="font-body text-[0.8125rem] sm:text-[0.875rem] tracking-[0em] leading-[1.6] font-normal text-slate-600">
                  {item}
                </span>
              </div>
            ))}
...
<section className="px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 py-12 sm:py-16 md:py-20 lg:py-24 bg-[#06457F] grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-16">

  {/* Vision */}
  <div className="p-6 sm:p-8 md:p-10 border border-[#0474C4]/25 rounded-sm bg-white">
    <span className="font-body text-[0.625rem] sm:text-[0.6875rem] tracking-[0.07em] uppercase font-medium text-[#0474C4] mb-4 sm:mb-5 block">
      Our Vision
    </span>

    <h2 className="font-heading text-[1.125rem] sm:text-[1.25rem] md:text-[1.375rem] tracking-[-0.005em] leading-[1.3] font-medium text-[#071639] mb-3 sm:mb-4">
...
Promotes excellence in professional education and research capacity development through accessible online certification, consulting, and evaluation services.</p>
 ...
 <section className="font-body bg-[#F9F9FB] py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 w-full">
    ...
    <p className="font-body text-[0.9375rem] sm:text-[1rem] tracking-[-0.005em] leading-[1.7] font-normal text-slate-600 max-w-145">
      ...
      <div className="max-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-7 md:gap-8 items-start">
        {/* Left: CEO Photo + Name */}
        <div className="flex flex-col">
          <div className="relative w-full aspect-3/4 max-w-2xl h-72 sm:h-80 md:h-90 lg:h-100 overflow-hidden">
            <Image
        ...
        <div className="flex flex-col gap-3 sm:gap-4 self-start lg:pl-8">
          {/* Executive Committee */}
          <div className="bg-white p-6 sm:p-8 md:p-12">
            <h3 className="font-heading text-2xl sm:text-3xl font-light text-[#1a1a1a] tracking-tight leading-tight mb-4 sm:mb-5">
              Executive <br /> Committee
            </h3>
            <a
              href="#"
              className="inline-flex items-center gap-2 text-[#0474C4] text-xs sm:text-sm font-semibold uppercase tracking-widest hover:gap-4 transition-all duration-200 group"
            >
              Read more
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-28 w-full px-4 sm:px-6 md:px-10 lg:px-0 text-center bg-[#181C2C] relative overflow-hidden">
        <div className="relative max-w-140 mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center sm:flex-wrap">
            <Link
              href="/programs"
              className="font-body text-[0.8125rem] sm:text-[0.875rem] tracking-[0.02em] font-medium bg-[#0474C4] text-[#EBF3FC] border-[#0474C4] py-3 sm:py-3.5 px-5 h-11 sm:h-12 rounded-[32px] inline-flex items-center justify-center min-w-40 transition-colors duration-200 hover:bg-[#06457F] hover:border-[#06457F]"
            >
              Explore Programs{" "}
            </Link>
            ...
            <Link
              href="/contact"
              className="font-body text-[0.8125rem] sm:text-[0.875rem] tracking-[0.02em] font-medium bg-transparent text-[#EBF3FC] border border-[#EBF3FC] py-3 sm:py-3.5 px-5 h-11 sm:h-12 rounded-[32px] inline-flex items-center justify-center min-w-40 transition-colors duration-200 hover:bg-[#06457F] hover:border-[#06457F]"
            >
              Contact Us
            </Link>
          </div>
