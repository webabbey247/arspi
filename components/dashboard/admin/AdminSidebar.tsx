...
import { LayoutDashboard, Users, BookOpen, Award, Settings, LogOut } from "lucide-react"
import type { SessionPayload } from "@/lib/session"

const nav = [
  { href: "/administrator",          label: "Overview",    icon: LayoutDashboard },
  { href: "/administrator/users",    label: "Users",       icon: Users           },
  { href: "/administrator/courses",  label: "Courses",     icon: BookOpen        },
  { href: "/administrator/certificates", label: "Certificates", icon: Award      },
      ...
      <div className="px-4 py-4 border-t border-white/10 flex items-center justify-between gap-3">
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="font-body text-[0.625rem] text-slate-400 uppercase tracking-wider">Admin</p>
          </div>
        </div>
        <Link
